    ...
    <>
      ...
      <main>
        ...
        <section style={{
          ...
          <h1 style={{ fontSize:'clamp(44px,8vw,88px)', fontWeight:800, lineHeight:1.05, color:'#f8f5ef', marginBottom:12, animation:'fadeUp .8s ease .25s both' }}>
            التوظيف<br/>
          ...
          <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:'clamp(16px,2.5vw,24px)', fontWeight:300, fontStyle:'italic', color:'var(--muted)', marginBottom:32, animation:'fadeUp .8s ease .35s both' }}>Where talent meets opportunity</p>

          <p style={{ maxWidth:520, fontSize:17, color:'var(--muted)', lineHeight:1.8, marginBottom:48, animation:'fadeUp .8s ease .45s both' }}>
            لا CV جامد — بل محادثة ذكية تكشف قيمتك الحقيقية.<br/>
            نخبة تربط أفضل المرشحين بأفضل الشركات.
          </p>

          <div style={{ display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap', animation:'fadeUp .8s ease .55s both' }}>
            {/* ← هنا التغيير: يوجه لتسجيل الدخول أولاً */}
            <Link href="/auth/login" style={{ padding:'14px 36px', borderRadius:10, fontSize:16, fontWeight:700, background:'linear-gradient(135deg,#7a5e28,#c8a04a)', color:'#06060e' }}>
              ابدأ مقابلتك الذكية
            </Link>
            <Link href="/auth/login" style={{ padding:'14px 36px', borderRadius:10, fontSize:16, fontWeight:700, border:'1px solid var(--border)', color:'var(--muted)', background:'transparent' }}>
              للشركات
            </Link>
          </div>

          <div style={{ display:'flex', gap:48, justifyContent:'center', marginTop:72, flexWrap:'wrap', animation:'fadeUp .8s ease .7s both' }}>
        ...
        <section style={{ background:'var(--bg2)', borderTop:'1px solid var(--border)', borderBottom:'1px solid var(--border)', padding:'100px 40px' }}>
          <div style={{ maxWidth:1100, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:80, alignItems:'center' }}>
            <div>
              ...
              <p style={{ fontSize:15, color:'var(--muted)', marginTop:16, lineHeight:1.8 }}>بعد انتهاء مقابلتك، احصل على CV مكتوب باحترافية بتصميم أنيق — جاهز للتقديم الفوري.</p>
              <div style={{ background:'var(--surface)', border:'1px solid var(--border)', borderRadius:14, padding:28, marginTop:28 }}>
                ...
                <div style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:48, fontWeight:600, color:'var(--gold)', lineHeight:1 }}><sup style={{ fontSize:20, verticalAlign:'super' }}>ر.س</sup>39</div>
                <div style={{ fontSize:12, color:'var(--muted)', marginTop:6 }}>PDF + Word · عربي + English</div>
                <Link href="/auth/login" style={{ display:'flex', alignItems:'center', justifyContent:'center', marginTop:20, padding:'13px 24px', borderRadius:10, fontSize:15, fontWeight:700, background:'linear-gradient(135deg,#7a5e28,#c8a04a)', color:'#06060e' }}>ابدأ واحصل على CV</Link>
              </div>
            </div>
        ...
        <section style={{ padding:'100px 40px', textAlign:'center' }}>
          ...
          <p style={{ fontSize:16, color:'var(--muted)', maxWidth:400, margin:'0 auto 40px', lineHeight:1.8 }}>انضم إلى نخبة — المنصة التي تُقدّمك كما أنت.</p>
          <div style={{ display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap' }}>
            <Link href="/auth/login" style={{ padding:'14px 36px', borderRadius:10, fontSize:16, fontWeight:700, background:'linear-gradient(135deg,#7a5e28,#c8a04a)', color:'#06060e' }}>ابدأ مقابلتك المجانية</Link>
            <Link href="/auth/login" style={{ padding:'14px 36px', borderRadius:10, fontSize:16, fontWeight:700, border:'1px solid var(--border)', color:'var(--muted)', background:'transparent' }}>للشركات</Link>
          </div>
        </section>
        ...
        <footer style={{ padding:'36px 40px', borderTop:'1px solid var(--border)', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:16 }}>
          ...
          <div style={{ display:'flex', gap:24 }}>
            {['سياسة الخصوصية','الشروط','تواصل معنا'].map(l => <a key={l} href="#" style={{ fontSize:13, color:'var(--muted)' }}>{l}</a>)}
          </div>
        </footer>
      </main>
    </>
