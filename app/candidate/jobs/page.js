              ...
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:16 }}>
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
                    ...
                    {job.nationality_preference && job.nationality_preference !== 'all' && (
                      <span style={{ padding:'4px 12px', borderRadius:20, fontSize:12, background:C.surface, border:`1px solid ${C.border}`, color:C.muted }}>
                        🌍 {job.nationality_preference === 'saudi' ? 'سعودي فقط' : 'جنسيات أخرى'}
                      </span>
                    )}
