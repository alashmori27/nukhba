      ...
      <section style={{ padding:'80px 40px', textAlign:'center' }}>
        ...
        <div className="grid-3" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:16, maxWidth:860, margin:'0 auto' }}>
          <div style={{ background:'#181828', border:'1px solid #252538', borderRadius:16, padding:32, textAlign:'right' }}>
            ...
            {['٣ وظائف مجانية','تصفح المرشحين','مقابلات AI لمرشحيك','لوحة تحكم كاملة'].map(f => (
            ...
            <Link href="/auth/login" style={{ display:'block', marginTop:24, padding:'10px', borderRadius:10, fontSize:13, fontWeight:700, border:'1px solid #252538', color:'#7a7690', background:'transparent', textDecoration:'none', textAlign:'center' }}>
              ابدأ مجاناً
            </Link>
          </div>
          ...
          <div style={{ background:'rgba(200,160,74,.05)', border:'2px solid rgba(200,160,74,.4)', borderRadius:16, padding:32, textAlign:'right', position:'relative' }}>
            ...
            {['وظائف غير محدودة','تقييم AI لكل مرشح','نص المقابلة كاملاً','واتساب وإيميل مباشر','إشعارات فورية'].map(f => (
              <div key={f} style={{ display:'flex', alignItems:'center', gap:8, marginBottom:10, fontSize:13, color:'#ede8df' }}>
                <span style={{ color:'#4a9c6e' }}>✓</span>{f}
              </div>
            ))}
            <Link href="/auth/login" className="btn-gold" style={{ display:'block', marginTop:24, padding:'10px', borderRadius:10, fontSize:13, fontWeight:700, textDecoration:'none', textAlign:'center' }}>
              ابدأ الآن
            </Link>
          </div>
