...
const STAGE_GUIDELINES = {
  basics:       'First message only — greet briefly as نخبة and ask for name. Then sequentially: phone number (once only, explain it appears on CV), email address (البريد الإلكتروني — mention some companies prefer contacting by email), age, nationality (الجنسية), Saudi city, specialization/field, educational qualification.',
